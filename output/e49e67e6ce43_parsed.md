# Parsed dump — job e49e67e6ce43

- Source: `e49e67e6ce43_dela_4-1.pdf`
- Elements: 218
...
`[  46 · chart]` *(base64 21748 chars attached)*
...
`[  47 · figure]` *(base64 21748 chars attached)*
...
`[  50 · chart]` *(base64 26484 chars attached)*
...
`[  53 · figure]` *(base64 18824 chars attached)*
...
`[  54 · chart]` *(base64 18824 chars attached)*
...
`[  57 · equation]` *(base64 16956 chars attached)*

`[  58 · equation]` *(base64 11944 chars attached)*
...
`[  62 · table]` *(base64 16368 chars attached)*
...
`[  69 · equation]` *(base64 3668 chars attached)*
...
`[  72 · equation]` *(base64 10164 chars attached)*
...
> (row 1) · v
> By rows Av = By columns Av = V1 (column 1)+v2(column 2).
> (row 2) · v
...
`[  87 · table]` *(base64 25704 chars attached)*
...
`[  90 · equation]` *(base64 9200 chars attached)*
...
`[  93 · equation]` *(base64 7056 chars attached)*
...
`[  94 · chart]` *(base64 11896 chars attached)*
...
`[  99 · chart]` *(base64 51608 chars attached)*
...
`[ 103 · equation]` *(base64 7540 chars attached)*

`[ 104 · chart]` *(base64 6928 chars attached)*
...
`[ 107 · equation]` *(base64 11752 chars attached)*
...
`[ 110 · equation]` *(base64 12840 chars attached)*
...
`[ 121 · equation]` *(base64 10420 chars attached)*
...
`[ 125 · chart]` *(base64 34100 chars attached)*
...
`[ 130 · equation]` *(base64 21092 chars attached)*
...
`[ 135 · equation]` *(base64 5484 chars attached)*
...
`[ 143 · table]` *(base64 33100 chars attached)*
...
`[ 150 · equation]` *(base64 14592 chars attached)*
...
`[ 153 · equation]` *(base64 17928 chars attached)*
...
`[ 159 · equation]` *(base64 5160 chars attached)*
...
`[ 169 · equation]` *(base64 14308 chars attached)*

`[ 170 · paragraph]`

> 10 Compute each Ax in Problem 9 as a combination of the columns:

`[ 171 · equation]` *(base64 11660 chars attached)*
...
`[ 174 · equation]` *(base64 11024 chars attached)*
...
`[ 176 · equation]` *(base64 12724 chars attached)*
...
`[ 188 · equation]` *(base64 8000 chars attached)*
...
`[ 195 · equation]` *(base64 6640 chars attached)*
...
`[ 203 · table]` *(base64 9308 chars attached)*
