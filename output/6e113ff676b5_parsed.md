# Parsed dump — job 6e113ff676b5

- Source: `6e113ff676b5_Lec06 - Recurrent Neural Networks.pdf`
- Elements: 686
...
`[  20 · figure]` *(base64 128900 chars attached)*
...
`[  27 · figure]` *(base64 257964 chars attached)*
...
`[  32 · equation]` *(base64 25124 chars attached)*

`[  33 · equation]` *(base64 17540 chars attached)*

`[  34 · chart]` *(base64 31364 chars attached)*
...
`[  35 · equation]` *(base64 23896 chars attached)*

`[  36 · chart]` *(base64 23964 chars attached)*
...
`[  37 · equation]` *(base64 26212 chars attached)*
...
`[  42 · figure]` *(base64 143764 chars attached)*
...
`[  54 · figure]` *(base64 120492 chars attached)*
...
`[  69 · figure]` *(base64 411172 chars attached)*
...
`[  82 · figure]` *(base64 218592 chars attached)*
...
`[ 230 · figure]` *(base64 122924 chars attached)*
...
`[ 260 · figure]` *(base64 58828 chars attached)*
...
`[ 286 · figure]` *(base64 108128 chars attached)*
...
`[ 293 · figure]` *(base64 68180 chars attached)*
...
`[ 311 · figure]` *(base64 112976 chars attached)*
...
`[ 430 · figure]` *(base64 139196 chars attached)*
