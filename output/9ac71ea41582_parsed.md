# Parsed dump — job 9ac71ea41582

- Source: `9ac71ea41582_dela_4-1.pdf`
- Elements: 221
...
`[  72 · equation]` *(base64 3668 chars attached)*
...
`[ 133 · equation]` *(base64 21092 chars attached)*
...
`[ 146 · table]` *(base64 33100 chars attached)*
...
`[ 172 · equation]` *(base64 14308 chars attached)*

`[ 173 · paragraph]`

> 10 Compute each Ax in Problem 9 as a combination of the columns:

`[ 174 · equation]` *(base64 11660 chars attached)*
...
`[ 177 · equation]` *(base64 11024 chars attached)*
...
`[ 179 · equation]` *(base64 12724 chars attached)*
...
`[ 192 · equation]` *(base64 8000 chars attached)*
...
`[ 200 · equation]` *(base64 6640 chars attached)*
...
`[ 206 · table]` *(base64 9308 chars attached)*
